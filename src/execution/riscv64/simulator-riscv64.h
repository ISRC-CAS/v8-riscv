...
#include "src/codegen/riscv64/decoder-riscv64.h"
#include "src/diagnostics/riscv64/disasm-riscv64.h"
...
class Simulator : public DecoderVisitor, public SimulatorBase {
 public:
  ...
  // value of SCTLR_EL1.BT0. Details available in RISCV DDI 0487E.a, D5-2580.
...
#undef DECLARE_NEON_FP_PAIR_OP
  ...
  // TODO(riscv64): implement guarding at page granularity, rather than
  // globally.
  bool guard_pages_;
  ...
  // Synchronization primitives. See RISCV DDI 0487A.a, B2.10. Pair types not
  // implemented.
  ...
  // is implementation-defined, between 3 and 11. See RISCV DDI 0487A.a,
  // B2.10.3.
